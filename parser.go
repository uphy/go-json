...
yydefault:
	...
	case 1:
		...
		//line parser.go.y:33
		{
			yylex.(*Lexer).result = &yyDollar[1].object
		}
	case 2:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line parser.go.y:37
		{
			yylex.(*Lexer).result = yyDollar[1].array
		}
	case 3:
		yyDollar = yyS[yypt-3 : yypt+1]
		//line parser.go.y:43
		{
			yyVAL.object = Object{yyDollar[2].members}
		}
	case 4:
		yyDollar = yyS[yypt-2 : yypt+1]
		//line parser.go.y:47
		{
			yyVAL.object = Object{[]Member{}}
		}
	case 5:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line parser.go.y:53
		{
			yyVAL.members = []Member{yyDollar[1].member}
		}
	case 6:
		yyDollar = yyS[yypt-3 : yypt+1]
		//line parser.go.y:57
		{
			yyVAL.members = append(yyDollar[1].members, yyDollar[3].member)
		}
	case 7:
		yyDollar = yyS[yypt-3 : yypt+1]
		//line parser.go.y:63
		{
			yyVAL.member = Member{yyDollar[1].string, yyDollar[3].value}
		}
	case 8:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line parser.go.y:69
